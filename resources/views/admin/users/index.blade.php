          ...
          @if (count($users) > 0)
            @foreach ($users as $user)
              <tr>
                ...
                <td data-label="Car Type">{{ $user->car_type }}</td>
                <td data-label="Car Model">{{ $user->car_model }}</td>
                <td data-label="Car Size">{{ $user->car_size }}</td>
                <td data-label="License Plate">{{ $user->car_license_plate }}</td>
