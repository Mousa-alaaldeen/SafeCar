    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('bookings.update', $booking->id) }}" method="POST">
          ...
          <!-- Customer Name -->
          <div class="mb-3">
            <label class="form-label font-weight-bold" style="font-size: 14px; color: #333;">Customer Name</label>
            <p class="form-text"
          ...
          <!-- Phone Number -->
          <div class="mb-3">
            <label class="form-label font-weight-bold" style="font-size: 14px; color: #333;">Phone Number</label>
            <p class="form-text"
              style="border: 1px solid #ddd; padding: 6px 10px; border-radius: 8px; font-size: 14px; margin-bottom: 0; background-color: #fff;">
              {{ $booking->user->phone }}
            </p>
          ...
          <!-- Booking Date -->
          <div class="mb-3">
            <label class="form-label font-weight-bold" style="font-size: 14px; color: #333;">Booking Date</label>
            <p class="form-text"
              style="border: 1px solid #ddd; padding: 6px 10px; border-radius: 8px; font-size: 14px; margin-bottom: 0; background-color: #fff;">
