                            ...
                            <div class="col-md-6" style="min-height: 350px;">
                                <div class="position-relative h-100">
                                    <img class="position-absolute img-fluid w-100 h-100"
                                        src="{{asset('assets')}}/img/service-1.jpg" style="object-fit: cover;" alt="">
                                </div>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="tab-pane fade" id="tab-pane-2">
                        <div class="row g-4">
                            <div class="col-md-6" style="min-height: 350px;">
                                <div class="position-relative h-100">
                                    <img class="position-absolute img-fluid w-100 h-100"
                                        src="{{asset('assets')}}/img/service-2.jpg" style="object-fit: cover;" alt="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <h3 class="mb-3">15 Years Of Experience In Auto Servicing</h3>
        ...
        <div class="owl-carousel testimonial-carousel position-relative">
            <div class="testimonial-item text-center">
                ...
                <div class="testimonial-text bg-light text-center p-4">
                    <p class="mb-0">"The service was outstanding, and I’m extremely happy with the results!"</p>
                </div>
            </div>
            <div class="testimonial-item text-center">
                ...
                <p>Profession</p>
                <div class="testimonial-text bg-light text-center p-4">
                    <p class="mb-0">"I’ve been a loyal customer for years, and their services never disappoint!"</p>
                </div>
            </div>
            <div class="testimonial-item text-center">
                ...
                <p>Profession</p>
                <div class="testimonial-text bg-light text-center p-4">
                    <p class="mb-0">"Highly recommend them for any auto repairs. Excellent service and affordable prices."</p>
                </div>
            </div>
        </div>
    </div>
